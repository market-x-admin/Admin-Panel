...
const UploadMulti = ({ title, onFileUpload, register, fieldName }) => {
  ...
  return (
    ...
    <div className="  w-full h-[100px] bg-secondary  flex items-center justify-center ">
      ...
      <input
        {...register(fieldName)}
        className="block w-full text-sm text-gray-900  border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:placeholder-gray-400"
        id="file_input"
        type="file"
